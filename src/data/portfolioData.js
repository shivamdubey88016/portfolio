export const portfolioData = {
  name: 'Shivam Dubey',
  roles: ['Full Stack Developer', 'MERN Engineer', 'DSA Enthusiast', 'Creative Problem Solver'],
  profile:
  ...
  timeline: [
    {
      ...
      place: 'Dr. A.P.J. Abdul Kalam Technical University, Lucknow',
      meta: '2023 - Present | CGPA: 8.3',
    },
    {
      heading: 'Senior Secondary (Class XII)',
      place: 'M.J.K College, West Champaran, Bihar',
      meta: '2020 - 2022 | Percentage: 85%',
    },
    {
      heading: 'Achievements',
      place: 'IIT Kanpur, NIT Delhi, GGSIPU Delhi',
      meta: "Finalist in Policy Conclave'26 | Code Slayer 2k25 Participant | 200+ DSA problems solved",
    },
  ],
  social: {
